...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='ctseg',
                             help='ctdet | ctseg | ddd | multi_pose | exdet')
    ...
    # system
    self.parser.add_argument('--gpus', default='1,3',
    ...
    # ctseg
    self.parser.add_argument('--last_conv',type=str,default='3x3conv',
                             help ='1x1conv or 3x3 conv')
    self.parser.add_argument('--seg_feat', type=int, default=48,
                             help='seg conv feat num.')
    self.parser.add_argument('--seg_weight', type=float, default=1.,
                             help='loss weight for segment.')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.task == 'exdet':
      ...
      opt.heads = {'hm': opt.num_classes,
                   'wh': 2,
                   'reg':2,
                   'seg_feat':opt.seg_feat,
                   'seg':opt.seg_feat*9 if opt.last_conv == '3x3conv' else opt.seg_feat}
